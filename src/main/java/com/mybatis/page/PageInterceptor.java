...
import com.mybatis.autobuild.NameConverter;
 ...
 * 签名里要拦截的类型只能是接口。
 * 
 * StatementHandler是mybatis中本质解析执行sql的对象，mybatis通常拦截它以实现物理分页
 * @author com chen
 * 
 */
...
public class PageInterceptor implements Interceptor {
	...
	public StringBuilder buildPageSqlForMysql(String sql) {
		...
		pageSql.append(sql);
		pageSql.append(" limit " + beginrow + "," + PageContext.getPageSize());
		return pageSql;
	}
